...
export const MainFeel = () => {
    return (
        <Flex justifyContent='center' direction='column' alignItems='center'>
            <Text fontSize={['16px', '20px', '38px', '38px']}>HOW DO YOU FEEL TODAY?</Text>
            <Flex width='100%' justifyContent='space-between' alignItems='center' p='60px' direction={['column', 'column', 'row', 'row']}>
